...
ifeq ($(NVCC),)
    ...
    TARGETS += train_gpt2cu test_gpt2cu train_gpt2fp32cu test_gpt2fp32cu train_gpt2_weights_quantization $(NVCC_CUDNN)
endif
...
train_gpt2_weights_quantization: train_gpt2_weights_quantization.cu
	$(NVCC) $(NVCC_FLAGS) $(PFLAGS) $^ $(NVCC_LDFLAGS) $(NVCC_INCLUDES) $(NVCC_LDLIBS) $(CUDA_OUTPUT_FILE)
